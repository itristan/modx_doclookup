 ...
 */
/**
 * Build DocLookup Package
 *
 * : Build script for DocLookup package
 * @package itmg_doclookup
 * @subpackage build
 */


/* Set package info be sure to set all of these */
define('PKG_NAME','ITMG DocLookup');
define('PKG_NAME_LOWER','itmg_doclookup');
define('PKG_VERSION','1.0.0');
define('PKG_RELEASE','pl');
define('PKG_CATEGORY','ITMG DocLookup');
...
$sources= array (
    ...
    'docs' => $root . 'core/components/itmg_doclookup/docs/',
...
/* This section transfers every file in the local
 mycomponents/doclookup/assets directory to the
 target site's assets/doclookup directory on install.
...
/* This section transfers every file in the local 
 mycomponents/doclookup/core directory to the
 target site's core/doclookup directory on install.
